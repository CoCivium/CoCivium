...
Thus we become nations of post-truth extremists, warring tribes that align to self-aggrandizing figures who teach very different things to schools or parents. These tribes can become more entrenched if their ethics are questioned, or if their motives are challenged, growing less grounded in right and wrong as self-reflection is distorted. Meanwhile, our new thinking-technologies, invented only recently, act like civilizational scale tools for mass deformation. We are overwhelmed with their accelerating processes, their ability to undermine what we fundamentally believe and their acceleration of wealth and power inequalities, leaving many of us with less confidence in the future; but we are not yet hopeless...
...
It means competing with massive scalability, using a non-coercive, viral uptake of our software solutions and toolchains. It means charitable pay-it-forward, not commercial payback. It means CoCivium may never be held captive, by anyone, even some of us who help to build here; thus we are open source, so our systems and tools may be *trusted* to guide the more core-controller-like social products out there. CoCivium is thus a new kind of "movement", to prevent harm, by giving us and our AIs better ways to protect all of us.
